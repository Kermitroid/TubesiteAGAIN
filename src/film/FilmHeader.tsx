...
export default function FilmHeader({
  ...
  const recipeProps =
    selectedPhoto && !selectedPhoto?.recipeTitle
    ...
    <PhotoHeader
      ...
      entity={
        <PhotoFilm
          ...
          toggleRecipeOverlay={recipeProps ? () => setRecipeModalProps?.(recipeProps) : undefined}
        />
      }
      entityDescription={descriptionForFilmPhotos(photos, appText, undefined, count, dateRange)}
      photos={photos}
