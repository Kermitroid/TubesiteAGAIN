...
import { absolutePathForFocalLengthImage, pathForFocalLength } from '@/app/paths';
  ...
  return (
    <OGTile
      {...{
        ...
        description: descriptionForFocalLengthPhotos(photos, appText, true, count, dateRange),
