...
import { absolutePathForFocalLength, absolutePathForFocalLengthImage } from '@/app/paths';
...
export const formatFocalLength = (focal?: number) =>
  focal ? formatFocalLengthSafe(focal) : undefined;

export const formatFocalLengthSafe = (focal = 0) => `${focal}mm`;
...
export const shareTextFocalLength = (focal: number, appText: AppTextState) =>
