import { BASE_URL, IMAGE_QUALITY, VERCEL_BYPASS_KEY, VERCEL_BYPASS_SECRET } from '@/app/config';
...
export const getNextImageUrlForManipulation = (imageUrl: string, addBypassSecret: boolean) =>
