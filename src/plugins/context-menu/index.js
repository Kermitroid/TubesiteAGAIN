  ...
  constructor(player, initOpts) {
    ...
    const getMenuPosition = e => {
      ...
      if (ptrTop + menuSize.height > playerSize.height) {
        ...
        top =
          difference > menuSize.height / 2
            ? ptrTop - menuSize.height - 1
            : playerSize.height - menuSize.height;
      }
      ...
      if (ptrLeft + menuSize.width > playerSize.width) {
        ...
        left =
          difference > menuSize.width / 2
            ? ptrLeft - menuSize.width - 1
            : playerSize.width - menuSize.width;
      }
