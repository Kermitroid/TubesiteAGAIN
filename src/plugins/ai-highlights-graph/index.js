...
const HighlightsGraphPlugin = (function () {
  ...
  HighlightsGraphPlugin.prototype.setupHighlightsGraphElement =
    function setupHighlightsGraphElement() {
      this.progressBar = this.player.$('.vjs-progress-control');
      if (!this.progressBar) {
        return;
      }
      const graphHolder =
        this.player.$('.vjs-highlights-graph-display') || document.createElement('div');
   ...
   */
  HighlightsGraphPlugin.prototype.createPath = function createPath(
    dataArray,
    containerWidth,
    containerHeight
  ) {
  ...
  HighlightsGraphPlugin.prototype.createHighlightsGraph = function createHighlightsGraph(info) {
    ...
    const svg =
      this.player.$('.vjs-highlights-graph-display > svg') ||
