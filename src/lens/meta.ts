...
import { absolutePathForLens, absolutePathForLensImage } from '@/app/paths';
...
export const shareTextForLens = (lens: Lens, photos: Photo[], appText: AppTextState) =>
  [`${appText.category.lens}:`, formatLensText(lensFromPhoto(photos[0], lens))].join(' ');
...
export const generateMetaForLens = (
  ...
  description: descriptionForLensPhotos(photos, appText, true, explicitCount, explicitDateRange),
