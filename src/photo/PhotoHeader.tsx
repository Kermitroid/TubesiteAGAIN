...
import { Photo, PhotoDateRange, dateRangeForPhotos, titleForPhoto } from '.';
...
export default function PhotoHeader({
  ...
  const renderContentA =
    ...
    (selectedPhoto !== undefined && (
      <PhotoLink photo={selectedPhoto} className="uppercase font-bold truncate">
        ...
        >
          ...
          >
            {headerType === 'photo-detail-with-entity' ? (
              ...
              <h1
                className={clsx('w-full truncate', headerType !== 'photo-detail' && 'pr-1 sm:pr-2')}
              >
                {renderContentA}
              </h1>
            )}
            ...
            {entity && (
              <>
                {headerType === 'photo-set' ? (
                  ...
                  >
                    {appText.utility.paginateAction(paginationIndex, paginationCount, entityVerb)}
                  </ResponsiveText>
                )}
              </>
            )}
