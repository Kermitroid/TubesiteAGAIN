...
export default function StatusIcon({
  ...
  const getIcon = () => {
    switch (type) {
      ...
      case 'missing':
        return <BiSolidXSquare size={14.5} className="text-red-400" />;
      case 'warning':
        return <BiSolidXSquare size={14.5} className="text-amber-500" />;
      case 'optional':
  ...
  return (
    <span className={clsx('size-[16px]', 'inline-flex items-center justify-center', className)}>
      {loading ? (
