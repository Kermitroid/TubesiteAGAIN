    ...
    <Dialog isOpen onDismiss={onExit} className={styles.dialog}>
      ...
      <div className="p">
        ...
        <ul>
          ...
          <li>
            Additionally, Next.js gave us the ability to generate <em>new</em> versions of that page
            at runtime, which we used to generate previews.
          </li>
        </ul>
      </div>
      <div data-cta>
        ...
        <button onClick={copyShareUrl}>{didCopy ? 'Copied' : 'Copy URL'}</button>
      </div>
    </Dialog>
  );
}
