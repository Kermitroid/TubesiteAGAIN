...
export default function Modal({
  ...
  const [htmlElements, setHtmlElements] = useState<RefObject<HTMLDivElement | null>[]>([]);
  ...
  return (
    <motion.div
      className={clsx(
        ...
        anchor === 'top' ? 'items-start pt-4 sm:pt-12 lg:pt-24' : 'items-center',
      ...
      animate={{
        backgroundColor:
          resolvedTheme === 'dark' ? 'rgba(0, 0, 0, 0.80)' : 'rgba(255, 255, 255, 0.90)'
      }}
