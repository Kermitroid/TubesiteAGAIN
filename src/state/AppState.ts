...
import { Dispatch, SetStateAction, createContext, use, RefObject } from 'react';
...
export type AppStateContextType = {
  ...
  categoriesWithCounts?: Awaited<ReturnType<typeof getCountsForCategoriesCachedAction>>;
  // MODAL
