...
export const storeAuthEmailCookie = (email: string) => storeCookie(KEY_AUTH_EMAIL, email);

export const getAuthEmailCookie = () => getCookie(KEY_AUTH_EMAIL);

export const hasAuthEmailCookie = () => Boolean(getCookie(KEY_AUTH_EMAIL));

export const clearAuthEmailCookie = () => deleteCookie(KEY_AUTH_EMAIL);
