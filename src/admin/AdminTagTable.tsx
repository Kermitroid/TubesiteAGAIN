...
export default async function AdminTagTable({ tags }: { tags: Tags }) {
        ...
        <Fragment key={tag}>
          ...
          <div className={clsx('flex flex-nowrap', 'gap-2 sm:gap-3 items-center')}>
            ...
            <FormWithConfirm
              ...
              confirmText={`Are you sure you want to remove "${formatTag(tag)}" from ${photoQuantityText(count, appText, false, false).toLowerCase()}?`}
            >
