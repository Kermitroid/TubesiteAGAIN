...
export default function AdminTagForm({ tag, children }: { tag: string; children?: ReactNode }) {
  ...
  return (
    <form action={renamePhotoTagGloballyAction} className="space-y-8">
      <FieldSetWithStatus label="New Tag Name" value={updatedTagRaw} onChange={setUpdatedTagRaw} />
