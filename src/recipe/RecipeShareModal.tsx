...
import { formatRecipe, shareTextForRecipe, getRecipePropsFromPhotos, generateRecipeText } from '.';
...
export default function RecipeShareModal({
  ...
  const recipeText = data && film ? generateRecipeText({ data, film }) : undefined;
