import { AI_AUTO_GENERATED_FIELDS_DEFAULT, parseAiAutoGeneratedFieldsString } from '@/photo/ai';
...
export const VERCEL_GIT_PROVIDER = process.env.NEXT_PUBLIC_VERCEL_GIT_PROVIDER;
export const VERCEL_GIT_REPO_OWNER = process.env.NEXT_PUBLIC_VERCEL_GIT_REPO_OWNER;
export const VERCEL_GIT_REPO_SLUG = process.env.NEXT_PUBLIC_VERCEL_GIT_REPO_SLUG;
export const VERCEL_GIT_BRANCH = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_REF;
export const VERCEL_GIT_COMMIT_MESSAGE = process.env.NEXT_PUBLIC_VERCEL_GIT_COMMIT_MESSAGE;
...
export const VERCEL_PROJECT_URL =
  VERCEL_BRANCH_URL && VERCEL_GIT_BRANCH
...
export const BASE_URL_SHARE = makeUrlAbsolute(SITE_DOMAIN_SHARE)?.toLocaleLowerCase();
...
export const NAV_TITLE = process.env.NEXT_PUBLIC_NAV_TITLE;
...
export const IS_META_DESCRIPTION_CONFIGURED =
  Boolean(process.env.NEXT_PUBLIC_META_DESCRIPTION) || Boolean(NAV_CAPTION);

export const META_DESCRIPTION =
  process.env.NEXT_PUBLIC_META_DESCRIPTION || NAV_CAPTION || SITE_DOMAIN;

export const NAV_TITLE_OR_DOMAIN = NAV_TITLE || SITE_DOMAIN_SHORT || META_TITLE;
...
// STORAGE: DATABASE
export const HAS_DATABASE = Boolean(process.env.POSTGRES_URL);
export const POSTGRES_SSL_ENABLED = process.env.DISABLE_POSTGRES_SSL === '1' ? false : true;

// STORAGE: REDIS
export const HAS_REDIS_STORAGE = Boolean(process.env.KV_URL);

// STORAGE: VERCEL BLOB
export const HAS_VERCEL_BLOB_STORAGE = Boolean(process.env.BLOB_READ_WRITE_TOKEN);
...
export const HAS_AWS_S3_STORAGE_CLIENT =
  Boolean(process.env.NEXT_PUBLIC_AWS_S3_BUCKET) && Boolean(process.env.NEXT_PUBLIC_AWS_S3_REGION);
...
export const HAS_MULTIPLE_STORAGE_PROVIDERS =
  [HAS_VERCEL_BLOB_STORAGE, HAS_CLOUDFLARE_R2_STORAGE, HAS_AWS_S3_STORAGE].filter(Boolean).length >
  1;
...
export const AI_TEXT_GENERATION_ENABLED = Boolean(process.env.OPENAI_SECRET_KEY);
...
export const IMAGE_QUALITY = process.env.NEXT_PUBLIC_IMAGE_QUALITY
...
export const SHOW_CAMERAS = CATEGORY_VISIBILITY.includes('cameras');
export const SHOW_LENSES = CATEGORY_VISIBILITY.includes('lenses');
export const SHOW_TAGS = CATEGORY_VISIBILITY.includes('tags');
export const SHOW_RECIPES = CATEGORY_VISIBILITY.includes('recipes');
export const SHOW_FILMS = CATEGORY_VISIBILITY.includes('films');
export const SHOW_FOCAL_LENGTHS = CATEGORY_VISIBILITY.includes('focal-lengths');
...
export const SHOW_TAKEN_AT_TIME = process.env.NEXT_PUBLIC_HIDE_TAKEN_AT_TIME !== '1';
...
export const GRID_ASPECT_RATIO = process.env.NEXT_PUBLIC_GRID_ASPECT_RATIO
  ...
  : 1;
export const PREFERS_LOW_DENSITY_GRID = process.env.NEXT_PUBLIC_SHOW_LARGE_THUMBNAILS === '1';
export const HIGH_DENSITY_GRID = GRID_ASPECT_RATIO <= 1 && !PREFERS_LOW_DENSITY_GRID;

// SETTINGS

export const GEO_PRIVACY_ENABLED = process.env.NEXT_PUBLIC_GEO_PRIVACY === '1';
export const ALLOW_PUBLIC_DOWNLOADS = process.env.NEXT_PUBLIC_ALLOW_PUBLIC_DOWNLOADS === '1';
export const PUBLIC_API_ENABLED = process.env.NEXT_PUBLIC_PUBLIC_API === '1';
export const PRIORITY_ORDER_ENABLED = process.env.NEXT_PUBLIC_IGNORE_PRIORITY_ORDER !== '1';
...
export const ADMIN_SQL_DEBUG_ENABLED = process.env.ADMIN_SQL_DEBUG === '1' && !IS_BUILDING;
...
export const APP_CONFIGURATION = {
  ...
  hasStorageProvider: HAS_VERCEL_BLOB_STORAGE || HAS_CLOUDFLARE_R2_STORAGE || HAS_AWS_S3_STORAGE,
  hasMultipleStorageProviders: HAS_MULTIPLE_STORAGE_PROVIDERS,
  currentStorage: CURRENT_STORAGE,
  // Auth
  hasAuthSecret: Boolean(process.env.AUTH_SECRET),
  hasAdminUser: Boolean(process.env.ADMIN_EMAIL) && Boolean(process.env.ADMIN_PASSWORD),
  // Content
  locale: APP_LOCALE,
  ...
  hasAiTextAutoGeneratedFields: Boolean(process.env.AI_TEXT_AUTO_GENERATED_FIELDS),
  // Performance
  ...
  arePhotoMatteColorsConfigured: Boolean(MATTE_COLOR) || Boolean(MATTE_COLOR_DARK),
  matteColor: MATTE_COLOR,
  matteColorDark: MATTE_COLOR_DARK,
  // Display
  hasCategoryVisibility: Boolean(process.env.NEXT_PUBLIC_CATEGORY_VISIBILITY),
  ...
  hasGridDensityPreference: Boolean(process.env.NEXT_PUBLIC_SHOW_LARGE_THUMBNAILS),
  // Settings
  ...
  areInternalToolsEnabled:
    ADMIN_DEBUG_TOOLS_ENABLED || ADMIN_DB_OPTIMIZE_ENABLED || ADMIN_SQL_DEBUG_ENABLED,
