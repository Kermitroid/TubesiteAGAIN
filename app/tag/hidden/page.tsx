...
const getPhotosHiddenMetaCached = cache(() => getPhotosMetaCached({ hidden: 'only' }));
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = descriptionForTaggedPhotos(undefined, appText, undefined, count, dateRange);
