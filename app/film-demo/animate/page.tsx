...
import { FUJIFILM_SIMULATION_FORM_INPUT_OPTIONS } from '@/platforms/fujifilm/simulation';
...
export default function FilmPage() {
  ...
  return (
    <AppGrid
      contentMain={
        <div className={clsx('flex items-center justify-center min-h-[30rem]')}>
          <div className="w-[250px] scale-[2.5]">
            <div className="dark:text-gray-500/50 uppercase">Film Simulation:</div>
            <PhotoFilm
