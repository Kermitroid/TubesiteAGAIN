...
export const generateStaticParams = staticallyGeneratePhotosIfConfigured('page');

interface PhotoProps {
  params: Promise<{ photoId: string }>;
}

export async function generateMetadata({ params }: PhotoProps): Promise<Metadata> {
...
export default async function PhotoPage({ params }: PhotoProps) {
  ...
  return <PhotoDetailPage {...{ photo, photos, photosGrid }} />;
}
