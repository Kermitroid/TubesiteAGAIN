...
class AnalyticsApi {
     ...
     * @param { boolean } searchParams.unique Use this query parameter to control how viewer data is counted:  - &#x60;true&#x60; means that a single user watching multiple times counts as 1 unique viewer - &#x60;false&#x60; means that all views count, even if from the same user.  The API accepts this parameter only when you use the &#x60;ccv&#x60; or &#x60;view&#x60; metric.            Viewers are unique for 1 day.  The API determines uniqueness based on a viewer&#39;s &#x60;user-agent&#x60; and IP address. This means that the API can filter viewers using multiple tabs to watch the same video multiple times, but cannot filter for viewers who use multiple browsers to watch the same content multiple times.
     * @param { &#39;3s&#39; | &#39;5s&#39; | &#39;10s&#39; | &#39;30s&#39; } searchParams.viewDuration Use this query parameter to define how many seconds a view has to last to be counted in analytics data.  - You can only use this parameter with the &#x60;view&#x60; metric. - The accepted values are &#x60;3s&#x60;, &#x60;5s&#x60;, &#x60;10s&#x60;, and &#x60;30s&#x60;.  - If you do not set this parameter, the API defaults to &#x60;5s&#x60;.
     ...
     */
    async getAggregatedMetrics(args) {
        return this.getAggregatedMetricsWithResponseHeaders(args).then((res) => res.body);
    }
    /**
     * Retrieve time-based and countable metrics like average watch time or the number of impressions over a certain period of time.
     * Retrieve aggregated metrics
     ...
     * @param { FilterBy2 } searchParams.filterBy Use this parameter to filter the API&#39;s response based on different data dimensions. You can serialize filters in your query to receive more detailed breakdowns of your analytics.  - If you do not set a value for &#x60;filterBy&#x60;, the API returns the full dataset for your project. - The API only accepts the &#x60;mediaId&#x60; and &#x60;mediaType&#x60; filters when you call &#x60;/data/metrics/play/total&#x60; or &#x60;/data/buckets/play-total/media-id&#x60;.  These are the available breakdown dimensions:  - &#x60;mediaId&#x60;: Returns analytics based on the unique identifiers of a video or a live stream. - &#x60;mediaType&#x60;: Returns analytics based on the type of content. Possible values: &#x60;video&#x60; and &#x60;live-stream&#x60;.  - &#x60;continent&#x60;: Returns analytics based on the viewers&#39; continent. The list of supported continents names are based on the [GeoNames public database](https://www.geonames.org/countries/). You must use the ISO-3166 alpha2 format, for example &#x60;EU&#x60;. Possible values are: &#x60;AS&#x60;, &#x60;AF&#x60;, &#x60;NA&#x60;, &#x60;SA&#x60;, &#x60;AN&#x60;, &#x60;EU&#x60;, &#x60;AZ&#x60;.  - &#x60;country&#x60;: Returns analytics based on the viewers&#39; country. The list of supported country names are based on the [GeoNames public database](https://www.geonames.org/countries/). You must use the ISO-3166 alpha2 format, for example &#x60;FR&#x60;. - &#x60;deviceType&#x60;: Returns analytics based on the type of device used by the viewers. Response values can include: &#x60;computer&#x60;, &#x60;phone&#x60;, &#x60;tablet&#x60;, &#x60;tv&#x60;, &#x60;console&#x60;, &#x60;wearable&#x60;, &#x60;unknown&#x60;. - &#x60;operatingSystem&#x60;: Returns analytics based on the operating system used by the viewers. Response values can include &#x60;windows&#x60;, &#x60;mac osx&#x60;, &#x60;android&#x60;, &#x60;ios&#x60;, &#x60;linux&#x60;. - &#x60;browser&#x60;: Returns analytics based on the browser used by the viewers. Response values can include &#x60;chrome&#x60;, &#x60;firefox&#x60;, &#x60;edge&#x60;, &#x60;opera&#x60;. - &#x60;tag&#x60;: Returns analytics for videos using this tag. This filter only accepts a single value and is case sensitive. Read more about tagging your videos [here](https://docs.api.video/vod/tags-metadata). - &#x60;referrer&#x60;: Filters data based on the URL where the view is originating from. Accepts an empty string as a value to filter view events where no referrer is available.
     */
    async getAggregatedMetricsWithResponseHeaders({ metric, aggregation, from, to, unique, viewDuration, filterBy, }) {
        const queryParams = {};
        queryParams.headers = {};
        if (metric === null || metric === undefined) {
            throw new Error('Required parameter metric was null or undefined when calling getAggregatedMetrics.');
        }
        if (aggregation === null || aggregation === undefined) {
            throw new Error('Required parameter aggregation was null or undefined when calling getAggregatedMetrics.');
        }
        // Path Params
        const localVarPath = '/data/metrics/{metric}/{aggregation}'
            .substring(1)
            .replace('{' + 'metric' + '}', encodeURIComponent(String(metric)))
            .replace('{' + 'aggregation' + '}', encodeURIComponent(String(aggregation)));
        // Query Params
        const urlSearchParams = new url_1.URLSearchParams();
        if (from !== undefined) {
            urlSearchParams.append('from', ObjectSerializer_1.default.serialize(from, 'Date', 'date-time'));
        }
        if (to !== undefined) {
            urlSearchParams.append('to', ObjectSerializer_1.default.serialize(to, 'Date', 'date-time'));
        }
        if (unique !== undefined) {
            urlSearchParams.append('unique', ObjectSerializer_1.default.serialize(unique, 'boolean', ''));
        }
        if (viewDuration !== undefined) {
            urlSearchParams.append('viewDuration', ObjectSerializer_1.default.serialize(viewDuration, "'3s' | '5s' | '10s' | '30s'", ''));
        }
        if (filterBy !== undefined) {
            ...
            Object.keys(filterBy).forEach((k) => {
                if (filterBy[k] instanceof Object) {
                    Object.keys(filterBy[k]).forEach((key) => {
                        urlSearchParams.append(`filterBy[${k}][${key}]`, ObjectSerializer_1.default.serialize(filterBy[k][key], 'string', ''));
                    });
                }
                else {
                    urlSearchParams.append('filterBy[' + k + ']', ObjectSerializer_1.default.serialize(filterBy[k], 'string', ''));
                }
            });
        }
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                ...
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'AnalyticsAggregatedMetricsResponse', ''),
            };
        });
    }
    /**
     ...
     */
    async getMetricsBreakdown(args) {
        return this.getMetricsBreakdownWithResponseHeaders(args).then((res) => res.body);
    }
    /**
     * Retrieve detailed analytics play-rate and number of impressions segmented by dimensions like country or device type.
     * Retrieve metrics in a breakdown of dimensions
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async getMetricsBreakdownWithResponseHeaders({ metric, breakdown, from, to, sortBy, sortOrder, unique, viewDuration, filterBy, currentPage, pageSize, }) {
        const queryParams = {};
        queryParams.headers = {};
        if (metric === null || metric === undefined) {
            throw new Error('Required parameter metric was null or undefined when calling getMetricsBreakdown.');
        }
        if (breakdown === null || breakdown === undefined) {
            throw new Error('Required parameter breakdown was null or undefined when calling getMetricsBreakdown.');
        }
        // Path Params
        ...
        if (sortBy !== undefined) {
            urlSearchParams.append('sortBy', ObjectSerializer_1.default.serialize(sortBy, "'metricValue' | 'dimensionValue'", ''));
        }
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'AnalyticsMetricsBreakdownResponse', ''),
            };
        });
    }
    /**
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async getMetricsOverTime(args) {
        return this.getMetricsOverTimeWithResponseHeaders(args).then((res) => res.body);
    }
    /**
     * Retrieve countable metrics like the number of plays or impressions, grouped by the time at which they occurred
     * Retrieve metrics over time
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async getMetricsOverTimeWithResponseHeaders({ metric, from, to, interval, sortBy, sortOrder, unique, viewDuration, filterBy, currentPage, pageSize, }) {
        const queryParams = {};
        queryParams.headers = {};
        if (metric === null || metric === undefined) {
            throw new Error('Required parameter metric was null or undefined when calling getMetricsOverTime.');
        }
        // Path Params
        ...
        if (interval !== undefined) {
            urlSearchParams.append('interval', ObjectSerializer_1.default.serialize(interval, "'minute' | 'hour' | 'day'", ''));
        }
        if (sortBy !== undefined) {
            urlSearchParams.append('sortBy', ObjectSerializer_1.default.serialize(sortBy, "'metricValue' | 'emittedAt'", ''));
        }
        if (sortOrder !== undefined) {
            urlSearchParams.append('sortOrder', ObjectSerializer_1.default.serialize(sortOrder, "'asc' | 'desc'", ''));
        }
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'AnalyticsMetricsOverTimeResponse', ''),
            };
        });
    }
}
