...
class UploadTokensApi {
    ...
    async createToken(tokenCreationPayload = {}) {
        return this.createTokenWithResponseHeaders(tokenCreationPayload).then((res) => res.body);
    }
    /**
     * Generates an upload token that can be used to replace the API Key. More information can be found [here](https://docs.api.video/vod/delegated-upload-tokens)
     * Generate an upload token
     * @param tokenCreationPayload
     */
    async createTokenWithResponseHeaders(tokenCreationPayload = {}) {
        const queryParams = {};
        queryParams.headers = {};
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                ...
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'UploadToken', ''),
            };
        });
    }
    /**
    ...
    async getToken(uploadToken) {
        return this.getTokenWithResponseHeaders(uploadToken).then((res) => res.body);
    }
    /**
     * Retrieve details about a specific upload token by id.
     * Retrieve upload token
     * @param uploadToken The unique identifier for the token you want information about.
     */
    async getTokenWithResponseHeaders(uploadToken) {
        const queryParams = {};
        queryParams.headers = {};
    ...
    async deleteToken(uploadToken) {
        return this.deleteTokenWithResponseHeaders(uploadToken).then((res) => res.body);
    }
    /**
     * Delete an existing upload token. This is especially useful for tokens you may have created that do not expire.
     * Delete an upload token
     * @param uploadToken The unique identifier for the upload token you want to delete. Deleting a token will make it so the token can no longer be used for authentication.
     */
    async deleteTokenWithResponseHeaders(uploadToken) {
        const queryParams = {};
        queryParams.headers = {};
        if (uploadToken === null || uploadToken === undefined) {
    ...
    async listWithResponseHeaders({ sortBy, sortOrder, currentPage, pageSize, } = {}) {
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'TokenListResponse', ''),
            };
        });
    }
}
