...
class WatermarksApi {
    ...
    async uploadWithResponseHeaders(file) {
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                ...
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'Watermark', ''),
            };
        });
    }
    /**
     ...
     * @param watermarkId The watermark ID for the watermark you want to delete.
     */
    async deleteWithResponseHeaders(watermarkId) {
        const queryParams = {};
        queryParams.headers = {};
    ...
    async listWithResponseHeaders({ sortBy, sortOrder, currentPage, pageSize, }) {
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'WatermarksListResponse', ''),
            };
        });
    }
}
