...
class PlayerThemesApi {
    ...
    async create(playerThemeCreationPayload = {}) {
        return this.createWithResponseHeaders(playerThemeCreationPayload).then((res) => res.body);
    }
    /**
     * Create a player for your video, and customise it.
     * Create a player
     * @param playerThemeCreationPayload
     */
    async createWithResponseHeaders(playerThemeCreationPayload = {}) {
        const queryParams = {};
        queryParams.headers = {};
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                ...
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'PlayerTheme', ''),
            };
        });
    }
    /**
     ...
     * @param playerId The unique identifier for the player you want to retrieve.
     */
    async getWithResponseHeaders(playerId) {
        const queryParams = {};
        queryParams.headers = {};
    ...
    async update(playerId, playerThemeUpdatePayload = {}) {
        return this.updateWithResponseHeaders(playerId, playerThemeUpdatePayload).then((res) => res.body);
    }
    /**
     * Use a player ID to update specific details for a player.  NOTE: It may take up to 10 min before the new player configuration is available from our CDN.
     * Update a player
     ...
     * @param playerThemeUpdatePayload
     */
    async updateWithResponseHeaders(playerId, playerThemeUpdatePayload = {}) {
        const queryParams = {};
        queryParams.headers = {};
        if (playerId === null || playerId === undefined) {
     ...
     * @param playerId The unique identifier for the player you want to delete.
     */
    async deleteWithResponseHeaders(playerId) {
        const queryParams = {};
        queryParams.headers = {};
        if (playerId === null || playerId === undefined) {
     ...
     * @param { &#39;name&#39; | &#39;createdAt&#39; | &#39;updatedAt&#39; } searchParams.sortBy createdAt is the time the player was created. updatedAt is the time the player was last updated. The time is presented in ATOM UTC format.
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async listWithResponseHeaders({ sortBy, sortOrder, currentPage, pageSize, } = {}) {
        const queryParams = {};
        queryParams.headers = {};
        // Path Params
        const localVarPath = '/players'.substring(1);
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'PlayerThemesListResponse', ''),
            };
        });
    }
    /**
    ...
    async uploadLogo(playerId, file, link) {
        return this.uploadLogoWithResponseHeaders(playerId, file, link).then((res) => res.body);
    }
    /**
     * Upload an image file as a logo for your player. The image should fit within these constraints: - The image mime type must be `image/jpeg` or `image/png`. api.video recommends using `png` images with transparent background. - The image size should be a maximum of 200px width x 100px. - The file size should be a maximum of 100 KiB.
     * Upload a logo
     ...
     * @param link A public link that you want to advertise in your player. For example, you could add a link to your company. When a viewer clicks on your logo, they will be taken to this address.
     */
    async uploadLogoWithResponseHeaders(playerId, file, link) {
        const queryParams = {};
        queryParams.headers = {};
        if (playerId === null || playerId === undefined) {
     ...
     * @param playerId The unique identifier for the player.
     */
    async deleteLogoWithResponseHeaders(playerId) {
        const queryParams = {};
        queryParams.headers = {};
        if (playerId === null || playerId === undefined) {
