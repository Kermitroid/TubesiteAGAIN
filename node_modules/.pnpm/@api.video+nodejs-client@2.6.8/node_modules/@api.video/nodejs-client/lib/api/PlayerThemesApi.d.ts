...
export default class PlayerThemesApi {
     ...
     * @param playerThemeCreationPayload
     */
    createWithResponseHeaders(playerThemeCreationPayload?: PlayerThemeCreationPayload): Promise<{
     ...
     * @param playerId The unique identifier for the player you want to retrieve.
     */
    getWithResponseHeaders(playerId: string): Promise<{
        headers: ApiResponseHeaders;
        body: PlayerTheme;
    }>;
    /**
     ...
     * @param playerThemeUpdatePayload
     */
    updateWithResponseHeaders(playerId: string, playerThemeUpdatePayload?: PlayerThemeUpdatePayload): Promise<{
        headers: ApiResponseHeaders;
        body: PlayerTheme;
    }>;
    /**
     ...
     * @param playerId The unique identifier for the player you want to delete.
     */
    deleteWithResponseHeaders(playerId: string): Promise<{
        headers: ApiResponseHeaders;
        body: void;
    }>;
    /**
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    listWithResponseHeaders({ sortBy, sortOrder, currentPage, pageSize, }?: {
        sortBy?: 'name' | 'createdAt' | 'updatedAt';
        sortOrder?: 'asc' | 'desc';
        currentPage?: number;
        pageSize?: number;
     ...
     * @param link A public link that you want to advertise in your player. For example, you could add a link to your company. When a viewer clicks on your logo, they will be taken to this address.
     */
    uploadLogoWithResponseHeaders(playerId: string, file: string | Readable | Buffer, link?: string): Promise<{
        headers: ApiResponseHeaders;
        body: PlayerTheme;
    }>;
    /**
     ...
     * @param playerId The unique identifier for the player.
     */
    deleteLogoWithResponseHeaders(playerId: string): Promise<{
        headers: ApiResponseHeaders;
        body: void;
    }>;
}
