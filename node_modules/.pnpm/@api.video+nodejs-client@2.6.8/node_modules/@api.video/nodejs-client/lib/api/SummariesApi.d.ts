...
export default class SummariesApi {
     ...
     */
    create(summaryCreationPayload: SummaryCreationPayload): Promise<Summary>;
    /**
     * Generate an abstract and key takeaways for a video.
     * Generate video summary
     * @param summaryCreationPayload
     */
    createWithResponseHeaders(summaryCreationPayload: SummaryCreationPayload): Promise<{
     ...
     */
    update(summaryId: string, summaryUpdatePayload?: SummaryUpdatePayload): Promise<SummarySource>;
    /**
     * Update details for a summary.
     * Update summary details
     * @param summaryId The unique identifier of the summary source you want to update.
     * @param summaryUpdatePayload
     */
    updateWithResponseHeaders(summaryId: string, summaryUpdatePayload?: SummaryUpdatePayload): Promise<{
        headers: ApiResponseHeaders;
        body: SummarySource;
    }>;
    /**
     ...
     * @param summaryId The unique identifier of the summary you want to delete.
     */
    deleteWithResponseHeaders(summaryId: string): Promise<{
        headers: ApiResponseHeaders;
        body: void;
    }>;
    /**
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    listWithResponseHeaders({ videoId, origin, sourceStatus, sortBy, sortOrder, currentPage, pageSize, }: {
        videoId?: string;
        origin?: 'auto' | 'api';
        sourceStatus?: 'missing' | 'waiting' | 'failed' | 'completed' | 'unprocessable';
        sortBy?: 'createdAt' | 'updatedAt' | 'videoId';
     ...
     */
    getSummarySource(summaryId: string): Promise<SummarySource>;
    /**
     * Get all details for a summary.
     * Get summary details
     * @param summaryId The unique identifier of the summary source you want to retrieve.
     */
    getSummarySourceWithResponseHeaders(summaryId: string): Promise<{
        headers: ApiResponseHeaders;
        body: SummarySource;
    }>;
}
