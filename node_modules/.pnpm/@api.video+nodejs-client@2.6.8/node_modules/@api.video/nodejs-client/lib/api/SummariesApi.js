...
class SummariesApi {
     ...
     */
    async create(summaryCreationPayload) {
        return this.createWithResponseHeaders(summaryCreationPayload).then((res) => res.body);
    }
    /**
     * Generate an abstract and key takeaways for a video.
     * Generate video summary
     * @param summaryCreationPayload
     */
    async createWithResponseHeaders(summaryCreationPayload) {
        const queryParams = {};
        queryParams.headers = {};
        if (summaryCreationPayload === null ||
            summaryCreationPayload === undefined) {
            throw new Error('Required parameter summaryCreationPayload was null or undefined when calling create.');
        }
        // Path Params
        ...
        queryParams.body = ObjectSerializer_1.default.stringify(ObjectSerializer_1.default.serialize(summaryCreationPayload, 'SummaryCreationPayload', ''), contentType);
        queryParams.method = 'POST';
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'Summary', ''),
            };
        });
    }
    /**
     ...
     */
    async update(summaryId, summaryUpdatePayload = {}) {
        return this.updateWithResponseHeaders(summaryId, summaryUpdatePayload).then((res) => res.body);
    }
    /**
     * Update details for a summary.
     * Update summary details
     ...
     * @param summaryUpdatePayload
     */
    async updateWithResponseHeaders(summaryId, summaryUpdatePayload = {}) {
        const queryParams = {};
        queryParams.headers = {};
        if (summaryId === null || summaryId === undefined) {
            throw new Error('Required parameter summaryId was null or undefined when calling update.');
        }
        if (summaryUpdatePayload === null || summaryUpdatePayload === undefined) {
            throw new Error('Required parameter summaryUpdatePayload was null or undefined when calling update.');
        }
        // Path Params
        ...
        queryParams.headers['Content-Type'] = contentType;
        queryParams.body = ObjectSerializer_1.default.stringify(ObjectSerializer_1.default.serialize(summaryUpdatePayload, 'SummaryUpdatePayload', ''), contentType);
        queryParams.method = 'PATCH';
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'SummarySource', ''),
            };
        });
    }
    /**
     ...
     * @param summaryId The unique identifier of the summary you want to delete.
     */
    async deleteWithResponseHeaders(summaryId) {
        const queryParams = {};
        queryParams.headers = {};
        if (summaryId === null || summaryId === undefined) {
            throw new Error('Required parameter summaryId was null or undefined when calling delete.');
        }
        // Path Params
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    async listWithResponseHeaders({ videoId, origin, sourceStatus, sortBy, sortOrder, currentPage, pageSize, }) {
        const queryParams = {};
        queryParams.headers = {};
        // Path Params
        const localVarPath = '/summaries'.substring(1);
        ...
        if (videoId !== undefined) {
            urlSearchParams.append('videoId', ObjectSerializer_1.default.serialize(videoId, 'string', ''));
        }
        if (origin !== undefined) {
            urlSearchParams.append('origin', ObjectSerializer_1.default.serialize(origin, "'auto' | 'api'", ''));
        }
        if (sourceStatus !== undefined) {
            urlSearchParams.append('sourceStatus', ObjectSerializer_1.default.serialize(sourceStatus, "'missing' | 'waiting' | 'failed' | 'completed' | 'unprocessable'", ''));
        }
        if (sortBy !== undefined) {
            urlSearchParams.append('sortBy', ObjectSerializer_1.default.serialize(sortBy, "'createdAt' | 'updatedAt' | 'videoId'", ''));
        }
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'SummariesListResponse', ''),
            };
        });
    }
    /**
     ...
     */
    async getSummarySource(summaryId) {
        return this.getSummarySourceWithResponseHeaders(summaryId).then((res) => res.body);
    }
    /**
     * Get all details for a summary.
     * Get summary details
     * @param summaryId The unique identifier of the summary source you want to retrieve.
     */
    async getSummarySourceWithResponseHeaders(summaryId) {
        const queryParams = {};
        queryParams.headers = {};
        if (summaryId === null || summaryId === undefined) {
            throw new Error('Required parameter summaryId was null or undefined when calling getSummarySource.');
        }
        // Path Params
        const localVarPath = '/summaries/{summaryId}/source'
            .substring(1)
