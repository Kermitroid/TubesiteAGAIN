...
class ChaptersApi {
    ...
    async uploadWithResponseHeaders(videoId, language, file) {
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                ...
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'Chapter', ''),
            };
        });
    }
    /**
    ...
    async listWithResponseHeaders({ videoId, currentPage, pageSize, }) {
        ...
        return this.httpClient.call(localVarPath, queryParams).then((response) => {
            return {
                headers: response.headers,
                body: ObjectSerializer_1.default.deserialize(ObjectSerializer_1.default.parse(response.body, response.headers['content-type']), 'ChaptersListResponse', ''),
            };
        });
    }
}
