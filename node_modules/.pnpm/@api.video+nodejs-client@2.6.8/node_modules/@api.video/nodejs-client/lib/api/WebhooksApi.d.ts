...
export default class WebhooksApi {
     ...
     * @param webhooksCreationPayload
     */
    createWithResponseHeaders(webhooksCreationPayload: WebhooksCreationPayload): Promise<{
     ...
     * @param webhookId The unique webhook you wish to retreive details on.
     */
    getWithResponseHeaders(webhookId: string): Promise<{
        headers: ApiResponseHeaders;
        body: Webhook;
    }>;
    /**
     ...
     * @param webhookId The webhook you wish to delete.
     */
    deleteWithResponseHeaders(webhookId: string): Promise<{
        headers: ApiResponseHeaders;
        body: void;
    }>;
    /**
  ...
  You can filter what the webhook list that the API returns using the parameters described below.
     ...
     * @param { number } searchParams.pageSize Results per page. Allowed values 1-100, default is 25.
     */
    listWithResponseHeaders({ events, currentPage, pageSize, }?: {
        events?: string;
        currentPage?: number;
        pageSize?: number;
    }): Promise<{
