...
export default class AdvancedAuthenticationApi {
     ...
     * @param authenticatePayload
     */
    authenticateWithResponseHeaders(authenticatePayload: AuthenticatePayload): Promise<{
     ...
     * @param refreshTokenPayload
     */
    refreshWithResponseHeaders(refreshTokenPayload: RefreshTokenPayload): Promise<{
        headers: ApiResponseHeaders;
        body: AccessToken;
    }>;
}
