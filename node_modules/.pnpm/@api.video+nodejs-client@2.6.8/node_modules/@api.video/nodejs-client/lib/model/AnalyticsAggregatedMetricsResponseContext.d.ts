...
export type AnalyticsAggregatedMetricsResponseContextMetricEnum = 'play' | 'start' | 'end' | 'impression' | 'impression-time' | 'watch-time' | 'ccv' | 'unique-ccv' | 'view-3' | 'view-5' | 'view-10' | 'view-30' | 'unique-view' | 'unique-view-3' | 'unique-view-5' | 'unique-view-10' | 'unique-view-30';
export type AnalyticsAggregatedMetricsResponseContextAggregationEnum = 'count' | 'rate' | 'total' | 'average' | 'sum';
