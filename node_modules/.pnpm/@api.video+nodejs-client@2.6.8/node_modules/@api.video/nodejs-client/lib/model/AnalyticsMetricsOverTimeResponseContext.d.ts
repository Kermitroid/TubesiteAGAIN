...
export type AnalyticsMetricsOverTimeResponseContextMetricEnum = 'play' | 'play-rate' | 'start' | 'end' | 'impression' | 'ccv-average' | 'ccv-peak' | 'unique-ccv-average' | 'unique-ccv-peak' | 'view-3' | 'view-5' | 'view-10' | 'view-30' | 'unique-view' | 'unique-view-3' | 'unique-view-5' | 'unique-view-10' | 'unique-view-30';
export type AnalyticsMetricsOverTimeResponseContextIntervalEnum = 'minute' | 'hour' | 'day';
