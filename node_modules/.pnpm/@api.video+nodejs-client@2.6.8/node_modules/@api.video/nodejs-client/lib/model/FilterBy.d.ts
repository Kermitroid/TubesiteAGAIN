...
export default class FilterBy {
    ...
    'mediaType'?: FilterByMediaTypeEnum;
    /**
     ...
     */
    'continent'?: Array<FilterByContinentEnum>;
    /**
...
export type FilterByMediaTypeEnum = 'video' | 'live-stream';
export type FilterByContinentEnum = 'AS' | 'AF' | 'NA' | 'SA' | 'AN' | 'EU' | 'AZ';
