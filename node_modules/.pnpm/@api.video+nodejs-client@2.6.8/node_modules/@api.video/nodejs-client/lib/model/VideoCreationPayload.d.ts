...
export type VideoCreationPayloadLanguageEnum = 'ar' | 'ca' | 'cs' | 'da' | 'de' | 'el' | 'en' | 'es' | 'fa' | 'fi' | 'fr' | 'he' | 'hi' | 'hr' | 'hu' | 'it' | 'ja' | 'ko' | 'ml' | 'nl' | 'nn' | 'false' | 'pl' | 'pt' | 'ru' | 'sk' | 'sl' | 'te' | 'tr' | 'uk' | 'ur' | 'vi' | 'zh';
export type VideoCreationPayloadTranscriptSummaryAttributesEnum = 'abstract' | 'takeaways';
