...
export default class FilterBy1 {
     ...
     */
    'continent'?: Array<FilterBy1ContinentEnum>;
    /**
...
export type FilterBy1MediaTypeEnum = 'video' | 'live-stream';
export type FilterBy1ContinentEnum = 'AS' | 'AF' | 'NA' | 'SA' | 'AN' | 'EU' | 'AZ';
