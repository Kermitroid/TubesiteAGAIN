...
const SummariesApi_1 = __importDefault(require("./api/SummariesApi"));
const TagsApi_1 = __importDefault(require("./api/TagsApi"));
...
class ApiVideoClient {
    constructor(params) {
        ...
        this._analytics = new AnalyticsApi_1.default(this.httpClient);
        ...
        this._summaries = new SummariesApi_1.default(this.httpClient);
        this._tags = new TagsApi_1.default(this.httpClient);
