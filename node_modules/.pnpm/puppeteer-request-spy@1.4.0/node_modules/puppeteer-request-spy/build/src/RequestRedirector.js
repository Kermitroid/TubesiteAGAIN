...
exports.RequestRedirector = void 0;
...
class RequestRedirector {
    constructor(patterns, redirectionUrl) {
    ...
    getOverride(interceptedRequest) {
        return __awaiter(this, void 0, void 0, function* () {
            return {
                url: (yield resolveOptionalPromise_1.resolveOptionalPromise(this.redirectionUrlFactory(interceptedRequest))),
...
exports.RequestRedirector = RequestRedirector;
