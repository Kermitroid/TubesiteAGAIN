...
class ResponseFaker {
    constructor(patterns, responseFake) {
        this.patterns = [];
        ...
        this.responseFakeFactory = typeof responseFake === 'function' ? responseFake : () => responseFake;
    }
    getResponseFake(request) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield resolveOptionalPromise_1.resolveOptionalPromise(this.responseFakeFactory(request));
        });
    }
...
exports.ResponseFaker = ResponseFaker;
