...
export declare enum ThumbnailTypes {
    jpeg = 6,
    tiff = 1
}
...
export declare class ExifData {
    ...
    app1Offset?: number;
    constructor(startMarker?: any, tags?: ExifTags, imageSize?: ImageSize, thumbnailOffset?: number, thumbnailLength?: number, thumbnailType?: ThumbnailTypes, app1Offset?: number);
    hasThumbnail(mime: any): boolean;
    getThumbnailOffset(): number;
    getThumbnailLength(): number;
    getThumbnailBuffer(): ArrayBuffer;
    private getThumbnailStream;
    getImageSize(): ImageSize;
    getThumbnailSize(): any;
}
