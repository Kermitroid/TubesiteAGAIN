...
const IPHONE_15_PRO_FRONT: Lens = {
  make: 'Apple',
  model: 'iPhone 15 Pro front TrueDepth camera 2.69mm f/1.9'
};
const IPHONE_15_PRO_BACK_WIDE: Lens = {
  make: 'Apple',
  model: 'iPhone 15 Pro back triple camera 6.765mm f/2.2'
};
const IPHONE_15_PRO_BACK_MAIN: Lens = {
  make: 'Apple',
  model: 'iPhone 15 Pro back triple camera 6.765mm f/1.78'
};
const IPHONE_15_PRO_BACK_TELEPHOTO: Lens = {
  make: 'Apple',
  model: 'iPhone 15 Pro back triple camera 6.765mm f/2.8'
};
const IPHONE_14_PRO_BACK_WIDE_NO_MAKE: Lens = {
  model: 'iPhone 14 Pro back dual wide camera 6.86mm f/1.78'
};
const IPHONE_12_PRO_MAX_BACK_WIDE_NO_MAKE: Lens = {
  model: 'iPhone 12 Pro Max back dual camera 7.5mm f/2.2'
};
const IPHONE_12_PRO_MAX_BACK_TELEPHOTO_NO_MAKE: Lens = {
  model: 'iPhone 12 Pro Max back triple camera 5.1mm f/1.6'
};
...
describe('Lens', () => {
  describe('correctly formats', () => {
    it('iPhone lenses', () => {
      ...
      expect(formatLensText(IPHONE_15_PRO_FRONT, 'long')).toBe(
        'Apple iPhone 15 Pro front TrueDepth camera 2.69mm f/1.9'
      );
      ...
      expect(formatLensText(IPHONE_12_PRO_MAX_BACK_WIDE_NO_MAKE)).toBe(
        '12 Pro Max Telephoto (7.5mm)'
      );
      expect(formatLensText(IPHONE_12_PRO_MAX_BACK_TELEPHOTO_NO_MAKE)).toBe(
        '12 Pro Max Main (5.1mm)'
      );
    });
    it('Pixel lenses', () => {
