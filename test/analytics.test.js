...
describe('Analytics tests', () => {
  ...
  it('Analytics requests', async () => {
    ...
    const requestInterceptor = new RequestInterceptor((testee, keyword) =>
      testee.startsWith(keyword)
    );
  ...
  it('Test volume event', async () => {
    ...
    await page.waitFor(1000);
    await page.click(
      '#player > .vjs-control-bar > .vjs-volume-panel.vjs-control.vjs-volume-panel-horizontal > button'
    );
