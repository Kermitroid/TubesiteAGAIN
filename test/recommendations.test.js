describe('Recommendations tests', () => {
  ...
  it('Test recommendations visibility', async () => {
    ...
    await page.waitFor(1000);
    expect(await page.$eval('.vjs-recommendations-overlay', o => o.style.visibility)).toEqual(
      'hidden'
    );
  ...
  it('Test recommendations click', async () => {
    ...
    await page.click(
      '#player > div.vjs-recommendations-overlay > div > div > .vjs-recommendations-overlay-item.vjs-recommendations-overlay-item-primary > .vjs-recommendations-overlay-item-primary-image'
    );
