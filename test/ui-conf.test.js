describe('UI configuration tests', () => {
  ...
  it('Test +/-10 sec', async () => {
    ...
    await page.click(
      '#player > div.vjs-control-bar > button.vjs-play-control.vjs-control.vjs-button'
    );
    ...
    await page.click(
      '#player > div.vjs-control-bar > button.vjs-control.vjs-icon-skip-10-plus.vjs-button'
    );
    await page.waitFor(1000);
    await page.waitForFunction('player.videojs.readyState() === 4');
    ...
    await page.click(
      '#player > div.vjs-control-bar > button.vjs-control.vjs-icon-skip-10-min.vjs-button'
    );
    await page.waitFor(1000);
    await page.waitForFunction('player.videojs.readyState() === 4');
    newTime = await page.$eval(
      '#player > .vjs-control-bar > .vjs-current-time.vjs-time-control.vjs-control > .vjs-current-time-display',
      vt => Number(vt.textContent.replace('0:', ''))
    );
  ...
  it('Test logo and logo click url', async () => {
    ...
    let backImage = await page.$eval(
      '#player > div.vjs-control-bar > a',
