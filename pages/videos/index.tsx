    ...
    <div className="global-container">
      ...
      <main>
        <div className="texts-container">
          ...
          <p>
            Please, add your api.video API key in your <i>.env</i> file and let the power of the API
            do the rest 🎩
          </p>
        </div>
        ...
        {error && (
          <div className="error">
            An error occurred trying to fetch your videos. Be sure to have you API key set in your
            .env file this way: <i>API_KEY=YOUR_API_KEY</i>
          </div>
        )}
        {videosResponse && videosResponse.data?.length > 0 && (
          <div className="videos-list">
            {videosResponse.data.map(video => (
              <a className="video-card" href={`/videos/${video.videoId}`} key={video.videoId}>
                <h3>{video.title}</h3>
                <Image
